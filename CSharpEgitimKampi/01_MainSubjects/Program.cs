...
namespace _01_MainSubjects
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            totalPrice = ((totalHamgurgerPrice)+(totalCokePrice)+(totalWaterPrice)+(totalFriesPrice)+(totalPizzaPrice)+(totalLemonadePrice));
